...
class TrainingArguments(TrainingArguments):
    ...
    w_rkd_loss: float = field(default=0.5, metadata={"help": "weight for RKD loss"})
    w_gvendi_loss: float = field(default=1.0, metadata={"help": "weight for GVendi loss"})
    ...
    sinkhorn_reg : float = field(default=0.05, metadata={"help": "Regularization parameter for Sinkhorn algorithm in GVendi phase2"})
    proj_dim : int = field(default=512, metadata={"help": "Projection dimension for GVendi phase2"})
    gvendi_K_codebook: int = field(default=60, metadata={"help": "Number of codebook entries for GVendi phase2"})
    gvendi_num_grad_layers: int = field(default=1, metadata={"help": "Number of layers to compute gradients for GVendi phase2"})

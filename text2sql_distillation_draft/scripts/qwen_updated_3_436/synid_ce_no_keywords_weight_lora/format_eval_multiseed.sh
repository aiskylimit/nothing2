...
COLLECT_SCRIPT="${COLLECT_SCRIPT:-scripts/qwen_updated_3_436/synid_ce_no_keywords_weight_lora/collect_eval_results.py}"
...
usage() {
  cat <<'EOF'
Usage: bash scripts/qwen_updated_3_436/synid_ce_no_keywords_weight_lora/format_eval_multiseed.sh [benchmark ...]

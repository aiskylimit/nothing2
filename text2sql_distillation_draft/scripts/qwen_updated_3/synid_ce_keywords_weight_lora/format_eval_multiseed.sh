...
INFER_OUTPUT_ROOT="${INFER_OUTPUT_ROOT:-results/infer/synid_ce_keywords_weight_lora/qwen_updated_3}"
EVAL_OUTPUT_ROOT="${EVAL_OUTPUT_ROOT:-results/eval/synid_ce_keywords_weight_lora/qwen_updated_3}"
ETYPE="${ETYPE:-all}"
...
Formats and evaluates multi-seed inference outputs under:
  results/infer/synid_ce_keywords_weight_lora/qwen_updated_3/<benchmark>/seed*/

Benchmark args, if provided, must be one or more of:
  spider_data spider_syn spider_realistic spider_dk

Environment overrides:
  INFER_OUTPUT_ROOT     Default: results/infer/synid_ce_keywords_weight_lora/qwen_updated_3
  EVAL_OUTPUT_ROOT      Default: results/eval/synid_ce_keywords_weight_lora/qwen_updated_3
  ETYPE                 Default: all

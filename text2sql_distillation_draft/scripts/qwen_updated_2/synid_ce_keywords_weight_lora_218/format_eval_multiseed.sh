...
COLLECT_SCRIPT="${COLLECT_SCRIPT:-scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/collect_eval_results.py}"
...
usage() {
  cat <<'EOF'
Usage: bash scripts/qwen_updated_2/synid_ce_keywords_weight_lora_218/format_eval_multiseed.sh [benchmark ...]

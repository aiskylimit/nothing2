...
# FDD
bash ${BASE_PATH}/scripts/llama2/kd/kd_7B_13B_teacher_lora.sh ${BASE_PATH} 2012 1
...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=${DEVICE} bash ./scripts/llama2/eval/eval_main_${benchmark}_lora.sh ./ ${MASTER_PORT} 1 llama2-7B kd/7B_13B meta-llama/Llama-2-7b-hf --seed $seed --eval-batch-size 32
    done
done
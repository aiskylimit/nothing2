...
# Evaluate DistiLLM-2 trained GPT-2 model
...
# Model configuration
MODEL_PATH="${BASE_PATH}/results/gpt2/train/distillm2/0.1B_1.5B"  # Trained model
...
EVAL_SAVE_DIR="${BASE_PATH}/results/gpt2/eval/distillm2"

# DeepSpeed configuration
DEEPSPEED_CONFIG="configs/deepspeed/ds_config_zero2.json"

echo "================================================"
echo "DistiLLM-2 Evaluation: GPT-2 0.1B (Distilled)"
echo "================================================"

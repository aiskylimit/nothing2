...
# DistiLLM-2 Training for OpenLLaMA (7B → 3B)
...
# Model configuration
STUDENT_MODEL="openlm-research/open_llama_3b_v2"
TEACHER_MODEL="openlm-research/open_llama_7b_v2"
CKPT_NAME="openllama2-3B"
TEACHER_CKPT_NAME="openllama2-7B"
PEFT_CKPT="${BASE_PATH}/results/openllama2/train/init/${CKPT_NAME}/"
TEACHER_PEFT_CKPT="${BASE_PATH}/results/openllama2/train/sft/${TEACHER_CKPT_NAME}/"
...
SAVE_DIR="${BASE_PATH}/results/openllama2/train/distillm2/3B_7B"
...
echo "================================================"
echo "Starting DistiLLM-2 Training: OpenLLaMA 7B → 3B"
echo "================================================"

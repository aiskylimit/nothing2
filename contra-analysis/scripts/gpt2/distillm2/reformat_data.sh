...
# ================================================
# Reformat DistiLLM-2 Data for GPT-2 (1.5B → 0.1B)
# ================================================
...
INPUT_DIR="${BASE_PATH}/data/distillm2/gpt2"

# Output directory (formatted contrastive pairs)
OUTPUT_DIR="${BASE_PATH}/data/distillm2/gpt2/formatted"

echo "================================================"
echo "Reformatting DistiLLM-2 Data: GPT-2 1.5B → 0.1B"
echo "================================================"
...
echo "  bash scripts/gpt2/distillm2/train.sh"
echo "================================================"

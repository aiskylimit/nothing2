...
from distillm.losses import frfd_distillation_loss, get_fdd_loss, get_fdd_mse_hidden_state_loss, get_csd_loss, ab_div
    ...
    for epoch in range(args.epochs):
        ...
        for it, (model_batch, no_model_batch, gen_data) in enumerate(train_dataloader):
            ...
            if teacher_model is not None:
                ...
                if "fdd" in args.type:
                    if "fdd_mse_hidden_state" in args.type:
                        fdd_loss = get_fdd_mse_hidden_state_loss(
...
def main():
    ...
    if args.velocity_field_path is not None or args.projector_path is not None:
    ...
    if "contra" in args.type and velocity_field is not None:

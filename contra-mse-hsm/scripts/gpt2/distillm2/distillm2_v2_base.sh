...
# length
MAX_LENGTH=512
# DistiLLM-2 specific (matching original implementation)
LOSS_TYPE="distillm_v2"
BASE_ALPHA_1=0.1
BASE_ALPHA_2=0.1
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/distillm2/v2_base"
# seed
SEED=10
...
# distillm2 specific (matching original implementation)

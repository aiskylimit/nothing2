...
# FDD
bash ${BASE_PATH}/scripts/openllama2/kd/kd_3B_7B_teacher_lora.sh ${BASE_PATH} 2012 1
...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=${DEVICE} bash ./scripts/openllama2/eval/eval_main_${benchmark}_lora.sh ./ ${MASTER_PORT} 1 openllama2-3B kd/3B_7B openlm-research/open_llama_3b_v2 --seed $seed --eval-batch-size 32
    done
done

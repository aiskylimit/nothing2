...
# Student and teacher checkpoints are downloaded automatically from Hugging Face
# by the from_pretrained calls in finetune.py.
bash "${BASE_PATH}/scripts/gpt2/fdd/fdd_curriculum.sh" \
  "${BASE_PATH}" \
  "${MASTER_PORT}" \
